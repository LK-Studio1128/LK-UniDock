...
void precalculate_parallel(triangular_matrix_cuda_t *m_data_list_cpu,
    ...
    std::vector<sz> atom_xs(thread * max_atom_num);  // maybe size_t is too large
    std::vector<sz> atom_ad(thread * max_atom_num);
    std::vector<fl> atom_charge(thread * max_atom_num);
    std::vector<int> atom_num(thread);
    std::vector<int> precalculate_matrix_size(thread);
    ...
    checkCUDA(cudaMemcpy(atom_xs_gpu, atom_xs.data(), thread * max_atom_num * sizeof(sz),
    ...
    // }
    checkCUDA(cudaMemcpy(atom_ad_gpu, atom_ad.data(), thread * max_atom_num * sizeof(sz),
                         cudaMemcpyHostToDevice));
    checkCUDA(cudaMemcpy(atom_charge_gpu, atom_charge.data(), thread * max_atom_num * sizeof(fl),
                         cudaMemcpyHostToDevice));
    checkCUDA(cudaMemcpy(atom_num_gpu, atom_num.data(), thread * sizeof(int), cudaMemcpyHostToDevice));
    ...
    std::vector<triangular_matrix_cuda_t> m_data_cpu_list(thread);
    ...
    std::memcpy(m_data_list_cpu, m_data_cpu_list.data(),
                m_data_cpu_list.size() * sizeof(triangular_matrix_cuda_t));
